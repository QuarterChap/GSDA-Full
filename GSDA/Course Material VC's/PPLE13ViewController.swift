...
class PPLE13ViewController: UIViewController {
    ...
    func setupView() {
        ...
        let url = URL(string: "https://gadentalassisting.com/wp-content/uploads/2016/05/PP-LE13.pdf")
